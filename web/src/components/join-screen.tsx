    ...
    <main className="min-h-screen px-5 py-6 sm:px-8">
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] w-full max-w-3xl flex-col rounded-[2rem] border fine-line panel-strong">
        <header className="flex items-center justify-between border-b fine-line px-6 py-5 sm:px-8">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Paste an invite link or enter a room code.
            </p>
          </div>
          <Link
            href="/"
        ...
        <section className="flex flex-1 items-center px-6 py-10 sm:px-8">
          <div className="w-full rounded-[1.8rem] border fine-line bg-white/80 p-6 sm:p-8">
            ...
            <p className="mt-3 max-w-lg text-base leading-7 text-slate-600">
              ...
              <span className="font-semibold text-slate-900">late-lantern</span>{" "}
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-4">
              <input
                ...
                className="w-full rounded-[1.4rem] border fine-line bg-white px-4 py-3.5 text-sm outline-none transition placeholder:text-slate-400 focus:border-slate-900/25"
              />
              <button
                type="submit"
                className="w-full rounded-[1.4rem] bg-slate-950 px-5 py-3.5 text-sm font-semibold text-white transition hover:bg-slate-800"
              >
                Continue to setup
              </button>
            </form>

            <div className="mt-4 rounded-[1.4rem] border fine-line bg-slate-50 px-4 py-4 text-sm text-slate-500">
